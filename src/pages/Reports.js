...
class Reports extends C {
    constructor(props) {
        ...
        this.state = {
            ...
            ,defaultValue: { label: CHART_TYPE.LINE[0], value: CHART_TYPE.LINE[0] }
    ...
    _onChanged(e) {
        ...
        this.state.defaultValue = { label: e.value, value: e.value };
        this.forceUpdate();
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Select options={ this.state.options } onChange={ this._onChanged.bind(this) } defaultValue={ this.state.defaultValue } />
